...
import { footerSectionConfig } from "../sections/footer";
...
export function LandingNavbar({ logoTheme, onHomeClick }: LandingNavbarProps) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div
          className="fixed inset-0 z-50 bg-black transition-[opacity,visibility] duration-300 visible opacity-100"
          onClick={() => setIsOpen(false)}
        >
          <div className="flex h-full w-full items-stretch justify-center transition-[opacity,transform] duration-300 translate-y-0 scale-100 opacity-100">
            <div
