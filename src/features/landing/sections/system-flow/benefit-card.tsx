  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className={cx(
          styles.benefitCardIconBadge,
          "absolute right-[1.15rem] top-[1.15rem] grid size-11 place-items-center rounded-full bg-white/16 text-white ring-1 ring-white/28 backdrop-blur-md transition-transform duration-500 group-hover:scale-110 sm:right-[1.55rem] sm:top-[1.55rem] sm:size-12 md:size-14 lg:right-6 lg:top-6 lg:size-12 xl:size-14",
        )}
      >
      ...
      <div
        className={cx(
          styles.benefitCardContent,
          "relative z-10 max-w-full pr-[4.75rem] sm:pr-0 md:max-w-[82%] lg:max-w-[95%]",
        )}
      >
        <h3
          className={cx(
            styles.benefitCardTitle,
            "font-sans text-[1.4rem] font-semibold uppercase leading-[0.98] tracking-tight text-white sm:text-[1.9rem] md:text-[2.45rem] lg:text-[1.9rem] xl:text-[2.12rem] 2xl:text-[2.34rem]",
          )}
        >
          {title}
        </h3>
        ...
        <p
          className={cx(
            styles.benefitCardCopy,
            "mt-2 max-w-[40.6rem] text-body text-white md:mt-3 lg:mt-2 lg:max-w-[92%]",
          )}
        >
          {body}
        </p>
